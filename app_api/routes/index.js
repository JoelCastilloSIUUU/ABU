...
router
    .route('/users/:userid')
    .get(ctrlAuth.usuarioLeerUno)    // Read (Ver perfil con cursos enrolados)
    .put(ctrlAuth.usuarioActualizar) // Update (Editar nombre/contraseña)
    .delete(ctrlAuth.usuarioBorrar); // Delete (Borrar cuenta)

router.post('/users/:userid/cursos', ctrlAuth.usuarioInscribirCurso); // Inscribir a curso
router.put('/users/:userid/cursos/:cursoid', ctrlAuth.usuarioActualizarProgreso); // Calificación y Avance
